  ...
  return (
    <div className="">
      <div className="grid grid-cols-6">
        <div className=""><BuyCarSearchFilter/></div>
        <div className="col-span-5 w-11/12 mx-auto">
          <h3 className='text-4xl text-blue-900 mt-4'>Search Your Dream Car</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-2 m-auto  rounded-xl py-4">
            {CarListing && CarListing.length > 0 ? CarListing.map((car, index) => {
              return (
                <div className="bg-gray-100 shadow rounded p-2 border-b-2 border-r-2 border-gray-300 transform transition-transform duration-300 hover:scale-105" key={index}>
                  <div>
                    <Carousel
                      showStatus={false}
                      showArrows={true}
